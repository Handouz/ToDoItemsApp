...
namespace ToDoItems
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ToDoItemsContext>(opt => opt.UseSqlServer(
                Configuration.GetConnectionString("ToDoItemsConnection")));
            services.AddControllers();
            services.AddScoped<IToDoRepository, ToDoItemsRepository>();
